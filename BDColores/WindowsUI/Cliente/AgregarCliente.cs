...
namespace WindowsUI
{
    public partial class AgregarCliente : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string respuesta;
            respuesta = nuevo.NuevoCliente(this.textBox1.Text, this.textBox2.Text, this.textBox3.Text);
        ...
        {
            ClassColorBLL nuevo = new ClassColorBLL();
            this.dataGridView1.DataSource = nuevo.BuscaCliente(this.textBox4.Text);
            this.dataGridView1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
            this.dataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.AllCells;
            this.dataGridView1.ScrollBars = ScrollBars.Both;
            this.dataGridView1.ForeColor = Color.Black;
